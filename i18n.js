...
window.I18N = {
  ...
  fr: {
    ...
    soc: {
      ...
      desc: "Un agent d'investigation pour le SOC, une chaîne de triage de malware pour la Blue Team, l'architecture de sécurité qui les encadre et une analyse de rentabilité : environ 456 k€ de gain net par an et un retour sur investissement en 10,5 mois dans le scénario modélisé.",
      note: "Cas pratique · 25 min de lecture · PDF, 26 slides",
